...
namespace CursachApp.Migrations
{
    ...
    [Migration("20240221084738_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.DayOfWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Discipline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Group", b =>
                {
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.GroupDiscipline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.ScheduleItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Specialty", b =>
                {
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.SpecialtyDiscipline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.Group", b =>
                {
                    b.HasOne("CursachApp.Models.Entities.Specialty", "Specialty")
                        .WithMany()
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.GroupDiscipline", b =>
                {
                    b.HasOne("CursachApp.Models.Entities.Discipline", "Discipline")
                        .WithMany()
                        .HasForeignKey("DisciplineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CursachApp.Models.Entities.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CursachApp.Models.Entities.Group", null)
                        .WithMany("GroupDisciplines")
                        .HasForeignKey("GroupNumber1");

                    b.HasOne("CursachApp.Models.Entities.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.ScheduleItem", b =>
                {
                    b.HasOne("CursachApp.Models.Entities.DayOfWeek", "DayOfWeekDay")
                        .WithMany()
                        .HasForeignKey("DayOfWeekId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CursachApp.Models.Entities.GroupDiscipline", "GroupDiscipline")
                        .WithMany()
            ...
            modelBuilder.Entity("CursachApp.Models.Entities.User", b =>
                {
                    b.HasOne("CursachApp.Models.Entities.Post", "Post")
                        .WithMany()
